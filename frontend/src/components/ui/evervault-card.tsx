      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-4">
          <div className="relative h-44 w-44  rounded-full flex items-center justify-center text-white font-bold text-xl">
            ...
            <span className="dark:text-white text-black z-20 text-center px-6 leading-snug">{text}</span>
          </div>
          {description && (
            <p className="text-xs text-neutral-300 text-center px-4 py-2 leading-relaxed max-w-[220px] bg-black/80 rounded-lg backdrop-blur-sm">
              {description}
            </p>
          )}
        </div>
